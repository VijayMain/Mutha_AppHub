...
%>
	<table class="tftable">
		<tr style="font-size: 12px; background-color: #acc8cc; font-weight: bold; text-align: center; position:absolute; left: 0;  right: 15px;">
								<%
								...
								while(rs_head.next()){
								%>
								<td style="width: 180px;"><%=rs_head.getString("parameter") %> 
								<%if(!rs_head.getString("range_from").equalsIgnoreCase("")){ %><br/>
								[<%=rs_head.getString("range_from") %>/<%=rs_head.getString("range_to") %>] <% } %>
								</td>
								<%
								}
								%>
								<td style="width: 180px;">vendor_name</td>
							...
							%>
							<tr style="font-size: 8px;padding-top: 10px;">
								<%-- <td><%=rs_summary.getString("sr1")%></td> --%>
								<td style="width: 150px;"><%=rs_summary.getString("serial_no")%></td>
								<td style="width: 100px;"><%=rs_summary.getString("datetime_sheet")%></td>
								<td style="width: 180px;"><%=rs_summary.getString("batch")%></td>
								<td style="width: 180px;"><%=rs_summary.getString("machine")%></td>
								<td style="width: 100px;"><%=rs_summary.getString("operator")%></td>
								<td style="width: 180px;"><%=rs_summary.getString("top_id")%></td>
								<td style="width: 180px;"><%=rs_summary.getString("bot_id")%></td>
								<td style="width: 180px;"><%=rs_summary.getString("top_oval")%></td>
								<td style="width: 180px;"><%=rs_summary.getString("bot_oval")%></td>
								<td style="width: 180px;"><%=rs_summary.getString("taper")%></td>
								<td style="width: 180px;"><%=rs_summary.getString("od")%></td>
								<td style="width: 180px;"><%=rs_summary.getString("mh_ht")%></td>
								<td style="width: 180px;"><%=rs_summary.getString("parality")%></td>
								<td style="width: 180px;"><%=rs_summary.getString("th_ht")%></td>
								...
								<td style="width: 110px;"><%=rs_summary.getString("vendor_name")%></td> 
								<td style="width: 70px;"><%=rs_summary.getString("userName")%></td> 
							</tr>
							<%
								}
							%>
