				...
				<div style="width: 50%; float: left; height: 100%;">
					<form action="Import_MasterDataControl" method="post" enctype="multipart/form-data" onsubmit="return ValidationEvent()">
						<table class="tftable">
							...
							<tr>
								<td colspan="4" align="center"><input type="submit"	name="submit" id="importData" value="Import Data" class="button" /></td>
							</tr> 
						</table>
					</form>
				</div>
				<div style="width: 49%; float: right; height: 100%;">
				<form action="Collect_ReportDataControl" method="post" enctype="multipart/form-data">
					<table class="tftable">
							<tr style="font-size: 12px; background-color: #acc8cc; font-weight: bold;">
								<td colspan="4">Data Collect from system </td>
							</tr>
							<tr>
								<td>Import File From Location</td>
								<td colspan="3">D:\KT\Baker\data site</td>
							</tr>
							<tr>
								<td colspan="4" align="center"><input type="submit"	name="submit" id="importData" value="Import Data" class="button" /></td>
							</tr>
